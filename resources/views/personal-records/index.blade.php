    ...
    <div class="mb-6">
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="w-12 h-12 rounded-2xl bg-secondary/10 flex items-center justify-center">
                <x-lucide-trophy class="w-6 h-6 text-secondary"/>
            </div>
        ...
        @else
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                @foreach ($personalRecords as $record)
                    ...
                    <a href="{{ route('personal-records.show', $exercise) }}" class="block group">
                        <x-card.default variant="outline"
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div
                                    ...
                                    @else
                                        @if ($exercise->type->value === 'strength')
                                            <x-lucide-dumbbell class="w-6 h-6 text-secondary"/>
                                        @else
                                            <x-lucide-heart-pulse class="w-6 h-6 text-secondary"/>
                                        @endif
                                    @endif
                                </div>
                                {{-- Exercise --}}
                                <div class="min-w-0 flex-1">
                                    <div class="flex items-center justify-between gap-3">
                                        <h2 class="font-semibold text-primary truncate group-hover:text-secondary transition">
                                            {{ $exercise->name }}
                                        </h2>
                                ...
                                <div class="grid grid-cols-2 gap-3 mt-5">
                                    ...
                                    <div class="bg-surface-secondary rounded-xl p-3">
                                        <div class="flex items-center gap-2">
                                            <x-lucide-weight class="w-4 h-4 text-secondary"/>
                                    ...
                                    <div class="bg-surface-secondary rounded-xl p-3">
                                        <div class="flex items-center gap-2">
                                            <x-lucide-repeat-2 class="w-4 h-4 text-secondary"/>
                                            <span class="text-xs text-muted">
                                                {{ __('Most Reps') }}
                                            </span>
                                        </div>
                            ...
                            @if ($exercise->type->value === 'cardio')
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-5">
                                    ...
                                    <div class="bg-surface-secondary rounded-xl p-3">
                                        <div class="flex items-center gap-2">
                                            <x-lucide-clock-3 class="w-4 h-4 text-secondary"/>
                                    ...
                                    <div class="bg-surface-secondary rounded-xl p-3">
                                        <div class="flex items-center gap-2">
                                            <x-lucide-route class="w-4 h-4 text-secondary"/>
                                            <span class="text-xs text-muted">
                                                {{ __('Distance') }}
                                            </span>
                                        </div>
                                    ...
                                    <div class="bg-surface-secondary rounded-xl p-3">
                                        <div class="flex items-center gap-2">
                                            <x-lucide-flame class="w-4 h-4 text-secondary"/>
                                            <span class="text-xs text-muted">
                                                {{ __('Calories') }}
                                            </span>
                                        </div>
                            ...
                            {{-- View details --}}
                            <div class="flex items-center gap-2 mt-5 text-sm text-secondary">
